"""Tests for data_structures/binary_search_tree.py."""

from itertools import permutations

from animabotics.data_structures import SortedDict, SortedSet, PriorityQueue
...
def test_sorteddict():
    ...
    dst_dict = SortedDict()
    dst_dict.update(src_dict.items())
    assert dst_dict.to_dict() == src_dict
    # defaultdict check
